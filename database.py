...
db.execute("INSERT INTO stops (TourID,Name,TourIndex,Description,Lat,Long,Pic1,Category) VALUES (3, 'Chinese Historical Society of America Museum', 3, 'Chinatown is cruicial to the history of SF, and you can see that in the rich history of this museum.', 37.793844, -122.408779, 'https://upload.wikimedia.org/wikipedia/commons/2/2a/Dolores_Park,_San_Francisco_2013-04-13_14-48.jpg', 4)")
...
db.execute("INSERT INTO stops (TourID,Name,TourIndex,Description,Lat,Long,Pic1,Category) VALUES (5, 'Doe Library Reading Room', 1, 'The reading room, or Morrison Library, is one of the most beautiful parts of Doe Library.', 37.764176, -122.430668, 'https://s-media-cache-ak0.pinimg.com/736x/44/c0/6c/44c06c6be4b34436d862f222ac2e9fef.jpg', 2)")
db.execute("INSERT INTO stops (TourID,Name,TourIndex,Description,Lat,Long,Pic1,Category) VALUES (5, 'Grab a Coffee at FSM', 2, 'Students get tired studying all day, so make sure you grab a drink and a quick snack at the Free Speech Movement Cafe!', 37.872543, -122.26085, 'http://nickm.com/montfort_rettberg/implementation/2004-08-29/Berkeley_California__Free_Speech_Movement_Cafe_1a.jpg', 4)")


# Testing

db.execute("INSERT INTO stops (TourID,Name,TourIndex,Description,Lat,Long,Pic1,Category) VALUES (6, 'Lunchtime fun at Pier 23', 1, 'Everyone knows about Pier 39, but have you heard of the Cafe at Pier 23? The views are spectacular and theres no tourists!', 37.803378, -122.400909, 'http://si.wsj.net/public/resources/images/SF-AB925_LUNCHB_P_20130109105149.jpg', 2)")
db.execute("INSERT INTO stops (TourID,Name,TourIndex,Description,Lat,Long,Pic1,Category) VALUES (6, 'Shopping Downtown', 2, 'Westfield is the biggest mall within SF, and the place to go for luxury shopping.', 37.784212, -122.406873, 'https://c2.staticflickr.com/6/5061/5736050612_a8f21f1262_b.jpg', 4)")
db.execute("INSERT INTO stops (TourID,Name,TourIndex,Description,Lat,Long,Pic1,Category) VALUES (6, 'Chinese Historical Society of America Museum', 3, 'Chinatown is cruicial to the history of SF, and you can see that in the rich history of this museum.', 37.793844, -122.408779, 'https://upload.wikimedia.org/wikipedia/commons/2/2a/Dolores_Park,_San_Francisco_2013-04-13_14-48.jpg', 4)")

db.execute("INSERT INTO stops (TourID,Name,TourIndex,Description,Lat,Long,Pic1,Category) VALUES (7, 'Japantown', 1, 'Look around Japantown and eat some awesome sushi', 37.785413, -122.429383, 'http://si.wsj.net/public/resources/images/SF-AB925_LUNCHB_P_20130109105149.jpg', 2)")
db.execute("INSERT INTO stops (TourID,Name,TourIndex,Description,Lat,Long,Pic1,Category) VALUES (7, 'Chinese Historical Society of America Museum', 3, 'Chinatown is cruicial to the history of SF, and you can see that in the rich history of this museum.', 37.793844, -122.408779, 'https://upload.wikimedia.org/wikipedia/commons/2/2a/Dolores_Park,_San_Francisco_2013-04-13_14-48.jpg', 4)")
db.execute("INSERT INTO stops (TourID,Name,TourIndex,Description,Lat,Long,Pic1,Category) VALUES (7, 'Explore Little Italy', 2, 'The small area of Little Italy is located in the North Beach district, in the northeastern area of the city of San Francisco.', 37.800762, -122.410804, 'https://c2.staticflickr.com/6/5061/5736050612_a8f21f1262_b.jpg', 4)")
db.execute("INSERT INTO stops (TourID,Name,TourIndex,Description,Lat,Long,Pic1,Category) VALUES (7, 'Coit Tower', 3, 'This tower was a donation to the local firemen, and is shaped like a firehose.', 37.802395, -122.405822, 'https://upload.wikimedia.org/wikipedia/commons/2/2a/Dolores_Park,_San_Francisco_2013-04-13_14-48.jpg', 4)")

db.execute("INSERT INTO stops (TourID,Name,TourIndex,Description,Lat,Long,Pic1,Category) VALUES (8, 'AT&T Park Walk', 1, 'Home of the Giants!', 37.778595, -122.38927, 'http://si.wsj.net/public/resources/images/SF-AB925_LUNCHB_P_20130109105149.jpg', 2)")
db.execute("INSERT INTO stops (TourID,Name,TourIndex,Description,Lat,Long,Pic1,Category) VALUES (8, 'Lunch in Soma', 2, 'Some is the heart of tech in SF, and youll see plenty of unicorns walking its streets. Make sure to try the watermelon beer!', 37.789892, -122.390145, 'https://c2.staticflickr.com/6/5061/5736050612_a8f21f1262_b.jpg', 4)")
db.execute("INSERT INTO stops (TourID,Name,TourIndex,Description,Lat,Long,Pic1,Category) VALUES (8, 'South Park', 3, 'South Park is the citys startup capital, and where most of the citys startups were founded.' , 37.759773, -122.427063, 'https://upload.wikimedia.org/wikipedia/commons/2/2a/Dolores_Park,_San_Francisco_2013-04-13_14-48.jpg', 4)")
...
db.execute("INSERT INTO stops (TourID,Name,TourIndex,Description,Lat,Long,Pic1,Category) VALUES (11, 'Relax at Navy Pier', 3, 'Navy Pier is a not-for-profit originally opened as a shipping and recreational facility in 1916.', 41.889538, -87.628597, 'https://upload.wikimedia.org/wikipedia/commons/2/2a/Dolores_Park,_San_Francisco_2013-04-13_14-48.jpg', 4)")

...
#Tours Table
db.execute("CREATE TABLE tours (id INTEGER PRIMARY KEY, TourName TEXT, TourDescription TEXT, Rating INTEGER, Duration INTEGER, UserID INTEGER, CityID INTEGER, RatingNum INTEGER);")
db.execute("INSERT INTO tours (TourName,TourDescription,Rating,Duration,UserID,CityID,RatingNum) VALUES ('Perfect SF Hipster Sunday', 'Spend some time in the more alternative parts of SF, like the Castro and Haight-Ashbury. Experience the hippie culture for yourself, and dont forget your Tartine pastry!', 5, 3, 1, 1, 9)")
db.execute("INSERT INTO tours (TourName,TourDescription,Rating,Duration,UserID,CityID,RatingNum) VALUES ('Extreme SF', 'Who says you cant do outdoorsy things in a big city?', 4, 3, 1, 1, 1)")
db.execute("INSERT INTO tours (TourName,TourDescription,Rating,Duration,UserID,CityID,RatingNum) VALUES ('Scenic Views and Picnic Foods', 'Check out the beautiful views of SF, like Sutro Baths, Lands End, and Crissy Field. In between, enjoy a picnic at Baker Beach', 3, 4, 1, 1, 3)")
db.execute("INSERT INTO tours (TourName,TourDescription,Rating,Duration,UserID,CityID,RatingNum) VALUES ('SF Pub Crawl', 'You know what this is.', 3, 2, 4, 1, 4)")
db.execute("INSERT INTO tours (TourName,TourDescription,Rating,Duration,UserID,CityID,RatingNum) VALUES ('Get To Know Chicago', 'Berkeley is the number on Public University in the world! Learn more about it while living the life of an undergraduate student.', 1, 1, 3, 3, 4)")
db.execute("INSERT INTO tours (TourName,TourDescription,Rating,Duration,UserID,CityID,RatingNum) VALUES ('Downtown Lowdown', 'See what SF Downtown is all about', 5, 2, 4, 1, 7)")
db.execute("INSERT INTO tours (TourName,TourDescription,Rating,Duration,UserID,CityID,RatingNum) VALUES ('Heritage of the City', 'Visit the different ethnic areas of SF and experience new cultures', 5, 5, 2, 1, 5)")
db.execute("INSERT INTO tours (TourName,TourDescription,Rating,Duration,UserID,CityID,RatingNum) VALUES ('Startup Walk', 'See the tech areas and where all the local techies hang out.', 5, 1, 3, 1, 1)")
db.execute("INSERT INTO tours (TourName,TourDescription,Rating,Duration,UserID,CityID,RatingNum) VALUES ('Chi-town Low Dow', 'Get the low down on the best town around', 5, 3, 1, 3, 9)")
db.execute("INSERT INTO tours (TourName,TourDescription,Rating,Duration,UserID,CityID,RatingNum) VALUES ('Chicago Art Walk', 'With the Art Institute, MCA, The Picasso, and everything else, Chicago has one of the best art scenes around. Learn more in this tour through the city.', 5, 2, 1, 3, 7)")
db.execute("INSERT INTO tours (TourName,TourDescription,Rating,Duration,UserID,CityID,RatingNum) VALUES ('Midwest Feel in a Big City Town', 'Just because Chicago is a big city doesnt mean were not still in the Midwest. These are some of the nicest places to go in the city.', 3, 4, 1, 3, 3)")
db.execute("INSERT INTO tours (TourName,TourDescription,Rating,Duration,UserID,CityID,RatingNum) VALUES ('Chicago Financial District', 'Chicago is well known for its financial district. Take a walk in one of the worlds biggest financial district!', 4, 10, 1, 3, 1)")
...
db.execute("INSERT INTO stops (TourID,Name,TourIndex,Description,Lat,Long,Pic1,Category) VALUES (4, 'Get Coffee at Cute Cafe', 1, 'Dont miss the latte. ', 37.764176, -122.430668, 'http://si.wsj.net/public/resources/images/SF-AB925_LUNCHB_P_20130109105149.jpg', 2)")
...
db.execute("INSERT INTO stops (TourID,Name,TourIndex,Description,Lat,Long,Pic1,Category) VALUES (5, 'The Loop', 1, 'Although many believe the term The Loop comes from the elevated L trains that do indeed form a loop around the downtown area, the name actually comes from the route of a streetcar that served Chicago in 1882.', 41.884367, -87.628852, 'https://www.jcdrepair.com/assets/stores/loop-3e383688f323bbbcc8d91857992756fa.jpg', 2)")
db.execute("INSERT INTO stops (TourID,Name,TourIndex,Description,Lat,Long,Pic1,Category) VALUES (5, 'Ipsento', 1, 'If you think Starbucks is good, this will change your mind!', 41.918867, -87.687257, 'http://chicago.grubstreet.com/20110606_ipsento_560x372.jpg', 2)")
db.execute("INSERT INTO stops (TourID,Name,TourIndex,Description,Lat,Long,Pic1,Category) VALUES (5, 'DuSable Bridge', 1, 'Historic drawbridge with decorative work', 41.889046, -87.624368, 'http://historicbridges.org/truss/michiganavenue/little_p1160772_3_4_enhanced%202.jpg', 2)")
...
db.execute("INSERT INTO stops (TourID,Name,TourIndex,Description,Lat,Long,Pic1,Category) VALUES (10, 'Art Institute', 2, 'The Art Institute of Chicago is an encyclopedic art museum located in Chicagos Grant Park. It features a collection of Impressionist and Post-Impressionist art in its permanent collection', 41.879585, -87.623712, 'http://media-1.web.britannica.com/eb-media/05/124305-004-F9B15553.jpg', 2)")
